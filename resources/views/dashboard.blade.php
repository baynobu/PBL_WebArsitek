    ...
    <main class="relative min-h-screen overflow-hidden bg-white py-10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
            ...
            @elseif(auth()->user()->role === 'arsitek')
                <!-- ARSITEK DASHBOARD - LIST TENDER PROYEK -->
                <section class="relative overflow-hidden rounded-[2rem] border border-slate-100/70 bg-white/80 p-8 shadow-[0_18px_70px_rgba(15,23,42,0.12)] backdrop-blur-md">
                    <div class="max-w-3xl space-y-4">
                        <div class="flex items-center gap-2">
                            <span class="h-1.5 w-1.5 rounded-full bg-amber-600 animate-pulse"></span>
                            <p class="text-base font-bold uppercase tracking-[0.14em] text-slate-950">Tender Proyek Aktif</p>
                        </div>
                        <h1 class="text-4xl font-extrabold tracking-tight text-slate-950 sm:text-5xl">Daftar Tender Proyek</h1>
                        <p class="max-w-2xl text-sm leading-6 text-slate-600">Temukan proyek arsitektur aktif dari klien dan ajukan proposal penawaran Anda langsung di bawah ini.</p>
                    </div>
                </section>
                                ...
                                <div class="flex-1 p-8">
                                    <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <div class="flex-1">
                                                            <div class="flex items-center justify-between">
                                                                <p class="text-xs uppercase tracking-[0.22em] text-amber-600">Progress</p>
                                        ...
                                        <div class="flex items-start lg:pl-6 lg:pt-1">
                                            <a href="{{ route('proyek.show', $p) }}" class="inline-flex items-center justify-center rounded-xl bg-amber-700 px-5 py-3 text-sm font-medium text-white shadow-md shadow-amber-700/20 transition hover:bg-amber-800">Tinjau Detail</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    @empty
                        <div class="rounded-[28px] border border-slate-100 bg-white p-12 text-center shadow-sm">
                            <div class="mx-auto flex max-w-md flex-col items-center gap-4">
                                ...
                                <p class="text-base font-bold uppercase tracking-[0.14em] text-slate-950">Tidak ada tender proyek aktif.</p>
                                <p class="text-sm leading-6 text-slate-600">Saat ini belum ada tender proyek yang dibuka oleh klien.</p>
                            </div>
                        </div>
                    @endforelse
